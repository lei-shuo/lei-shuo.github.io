...
document.addEventListener('DOMContentLoaded', function() {
    ...
    style.innerHTML = `
        ...
        body::after {
            ...
            animation: auroraEffect 15s ease-in-out infinite alternate;
        }
        ...
        .site-toc-header {
            ...
            margin-bottom: 24px;
            padding-bottom: 16px;
            border-bottom: 3px solid rgba(103,126,234,0.3);
            display: flex;
            align-items: center;
            gap: 10px;
        ...
        .site-toc-content::-webkit-scrollbar {
            width: 6px;
        }
        
        .site-toc-content::-webkit-scrollbar-track {
            background: rgba(0,0,0,0.05);
            border-radius: 3px;
        }
        
        .site-toc-content::-webkit-scrollbar-thumb {
            background: linear-gradient(135deg,#667eea,#764ba2);
            border-radius: 3px;
        }
        ...
        .article-toc-content::-webkit-scrollbar {
            width: 4px;
        }
        
        .article-toc-content::-webkit-scrollbar-track {
            background: rgba(0,0,0,0.05);
            border-radius: 2px;
        }
        
        .article-toc-content::-webkit-scrollbar-thumb {
            background: linear-gradient(135deg,#f093fb,#f5576c);
            border-radius: 2px;
        }
